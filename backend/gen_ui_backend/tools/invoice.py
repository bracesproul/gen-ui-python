...
def invoice_parser(orderId: str, lineItems: List[LineItem], shippingAddress: Optional[ShippingAddress], customerInfo: Optional[CustomerInfo], paymentInfo: Optional[PaymentInfo]) -> Invoice:
